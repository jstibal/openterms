...
function fail(error: VerifyError, keyId: string | null, hash: string | null): VerifyResult {
...
export function verifyReceipt(receipt: Record<string, unknown>, jwks: Jwks): VerifyResult {
